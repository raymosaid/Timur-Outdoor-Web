...
const DialogContent = React.forwardRef(({ className, variant = 'default', size, position, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
...
const dialogVariants = cva(
	'fixed z-50 grid w-full max-w-lg gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 sm:rounded-lg',
	{
		variants: {
			variant: {
				default:
        ...
        right: 'inset-y-0 right-0 m-6 data-[state=closed]:slide-out-to-right-16 data-[state=open]:slide-in-from-right-16',
			},
			size: {
				default: 'max-w-lg',
				sm: 'max-w-md',
        ...
        xxl: 'max-w-3xl',
        xxxl: 'max-w-4xl',
        full: 'min-w-6xl max-w-6xl h-screen',
